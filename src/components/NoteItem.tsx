...
function NoteItem({
    ...
    return (
        <a key={note.id} onClick={onNoteClick} 
            href="#" className={selectedNote === note.id ? "" : "block max-w-sm m-2 p-2.5 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"}>
